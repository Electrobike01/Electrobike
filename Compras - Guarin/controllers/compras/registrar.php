...
$registrarCompra = $con->prepare(" INSERT INTO `compras`(`idCompra`, `idProveedor`, `valorT`, `fechaCompra`) 
...
//  INSERTAMOS LOS VALORES EN DETALLE COMPRA ------------
    $registrarDetalle = $con->prepare("INSERT INTO `detallecompra`(`idDetalleCompra`, `idProducto`, `idCompra`, `cantidad`, `valor`) 
