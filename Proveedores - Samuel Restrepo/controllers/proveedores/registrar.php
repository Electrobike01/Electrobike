...
if ($_POST) {
    ...
    $registrarProveedor = $con->prepare("INSERT INTO `proveedores`(`idProveedor`, `tipoDocumentoProveedor`, `documentoProveedor`, `nombreProveedor`, `correoProveedor`,`telefonoProveedor`, `estadoProveedor`)
