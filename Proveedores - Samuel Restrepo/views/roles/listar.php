                                    ...
                                    <div class="contenedorActualizarRol">
                                        ...
                                        <div class="contenedorActualizar">
                                            ...
                                            <div class="" id="">
                                                ...
                                                <div class=""><input type="text" id="idRol" class="form-control idRol_" name="idCliente" value="<?php echo $row['idRol']; ?>" disabled>
                                                </div>
                                            </div>

                                            <div class="" id="">
                                                <label class="formulario__label">Nombre </label>
                                                <div><input type="text" class="form-control nombreRolActualizado" name="nombreCliente" value="<?php echo $row['nombreRol']; ?>" id="input2">
                                                </div>
                                            </div>

                                            <input type="text" class="permisos_rol" name="nombreCliente" value="<?php echo $row['permisosRol']; ?>" style="display:none">
                                        ...
                                        <div class="contenedorBotones">
                                            ...
                                            <div class="botonGuardar">
                                                <button type="button" style="margin-right: 10px;" class="btn btn-primary guardarCambios" name="guardarClientes" id='guardarClientes'> Guardar </button>
                                            </div>
