...
<body class="animate-in-ov">
    ...
    <section class="home">
        ...
        <div id="checklist">
            ...
            <!-- checked -->
            <input value="1" name="r" type="checkbox" id="01"><label for="01">En configuración cambiar el rol</label>
            ...
            <input value="4" name="r" type="checkbox" id="04"><label for="04">Encriptar todas las variables localstorage</label>
            <input value="5" name="r" type="checkbox" id="05" checked><label for="05">Cambiar todas las ñ contraseña</label>
            <input value="6" name="r" type="checkbox" id="06"><label for="06">Olvidó contraseña</label>
            <input value="7" name="r" type="checkbox" id="07"><label for="07">Display none módulos móviles</label>
            ...
            <input value="9" name="r" type="checkbox" id="09"><label for="09">Buscador por categoría en productos (si pongo alta que muestre bicicletasBajaGama) </label>
            ...
            <input value="15" name="r" type="checkbox" id="15"><label for="15">Que en todos los modulos busque por TODO (estado,etc)</label>
            <input value="16" name="r" type="checkbox" id="16"><label for="16">Estilizar los inputs disable en todos</label>
            <input value="17" name="r" type="checkbox" id="17"><label for="17">En compras no puedo agregar dos compras "iguales" misma categ y mismo producto</label>
            <input value="18" name="r" type="checkbox" id="18"><label for="18">La tabla del carrito en compras sea responsive</label>
            <input value="19" name="r" type="checkbox" id="19"><label for="19">Estandarizar las tablas en todos</label>
            <input value="20" name="r" type="checkbox" id="20"><label for="20">Que en listar productos, se muestre la lista ordenada</label>
            ...
            <input value="23" name="r" type="checkbox" id="23"><label for="23">En todos los listar, cuando no hayan registros aparezca mensaje y link para registrar</label>
            ...
            <input value="25" name="r" type="checkbox" id="25"><label for="25">OPCIONAL: paginar las listas largas</label>
            ...
            <input value="32" name="r" type="checkbox" id="32"><label for="32">Crear ventana olvido contraseña</label>
            <input value="33" name="r" type="checkbox" id="33"><label for="33">Testear reporte de excel </label>
            ...
            <input value="38" name="r" type="checkbox" id="38"><label for="38">Carrito de compras que los inputs numericos no admitan texto</label>
            ...
            <input value="40" name="r" type="checkbox" id="40"><label for="40">Carrito estilizar inputs del carrito</label>
            <input value="41" name="r" type="checkbox" id="41"><label for="41">Que los botones del carrito editar y eliminar sean como el estandar </label>
            <input value="42" name="r" type="checkbox" id="42"><label for="42">Validar que no se repitan proveedores con el mismo nombre</label>
            <input value="43" name="r" type="checkbox" id="43" checked><label for="43">Cuando se cambie un rol de usuario se cierre sesion </label>
            <input value="44" name="r" type="checkbox" id="44"><label for="44">Cuando cambie la fecha en el computador que no se guarde asi en la BD</label>
            ...
            <input value="47" name="r" type="checkbox" id="47"><label for="47">En listar fechas hacer un calendario desde - hasta </label>
            ...
            <input value="49" name="r" type="checkbox" id="49"><label for="49">El tamaño en editar de los carritos es muy pequeño y no s eve el precio</label>
            <input value="50" name="r" type="checkbox" id="50"><label for="50">En el carrito del js poner el porcentaje sin que se dañe TODO</label>
            ...
            <input value="56" name="r" type="checkbox" id="56"><label for="56">- Poner mensaje si no hay registros en la tabla que aparezca el mensaje de "no se encontraron resultados" en: Proveedores, clientes, ventas, productos (NO SE SI ESTÁ)</label>
            ...
            <input value="59" name="r" type="checkbox" id="59"><label for="59"></label>
            <input value="60" name="r" type="checkbox" id="60"><label for="60"></label>
            <!-- 
            <input value="61" name="r" type="checkbox" id="61"><label for="61"></label>
