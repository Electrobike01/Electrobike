                    ...
                    <tbody>
                        ...
                        ?>
                            ...
                            <tr class="_<?php echo $i; ?> <?php echo $row['estadoUsuario']; ?>">
                                ...
                                <td class="text-center tipoDocumentoUsuario"><?php echo $row['tipoDocumentoUsuario']; ?></td>
                                    ...
                                    <div class="contenedorActualizarModulo">
                                        ...
                                        <div class="contenedorActualizar">
                                            ...
                                            <div class="" id="">
                                                ...
                                                <div class=""><input type="text" class="form-control idUsuario_" name="idUsuario" value="<?php echo  $row['idUsuario']; ?>" disabled>
                                                </div>
                                            </div>
                                            ...
                                            <div class="" id="">
                                                ...
                                                <select class="form-select tipoDocumentoUsuarioActualizado" name="tipoDocumentoUsuario" id="select1">
                                                    ...
                                                    <?php
                                                    if ($row['tipoDocumentoUsuario'] == 'Cédula') {
                                                        echo '<option value="Pasaporte">Pasaporte</option>';
                                                        echo '<option value="Cédula extranjera">Cédula extranjera</option>';
                                                    } elseif ($row['tipoDocumentoUsuario'] == 'Pasaporte') {
                                                        echo '<option value="Cédula">Cédula</option>';
                                                        echo '<option value="Cédula extranjera">Cédula extranjera</option>';
                                                    } elseif ($row['tipoDocumentoUsuario'] == 'Cédula extranjera') {
                                                        echo '<option value="Cédula">Cédula</option>';
                                                        echo '<option value="Pasaporte">Pasaporte</option>';
                                                    }
                                                    ?>
                                            ...
                                            <div class="">
                                                ...
                                                <div class="formulario__grupo-input">
                                                    <input type="text" class="form-control documentoUsuarioActualizado" name="documentoUsuario" value="<?php echo $row['documentoUsuario']; ?>" id="input1" oninput="filtroNumero(this)">
                                                </div>
                                            </div>
                                        ...
                                        <div class="contenedorBotones">
                                            <div class="botonGuardar">
                                                <!-- <input type="sumbit" class="btn btn-primary guardarRoles<?php // echo $i; 
                                                                                                                ?>" name="guardarProveedores" id='guardarRoles' value="Guardar"> -->
