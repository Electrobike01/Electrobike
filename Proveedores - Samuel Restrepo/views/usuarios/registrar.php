        ...
        <form>
            ...
            <main>
                ...
                <div class="formulario__grupo" id="grupo__password2">
                    <label for="password2" class="formulario__label">Nombre Completo</label>
                ...
                <div class="formulario">
                    ...
                    <div class="formulario__grupo" id="grupo__password2">
                        ...
                        <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" name="documentoUsuario" placeholder="Ingrese su documento" id="documentoUsuario"oninput="filtroNumero(this)">
                        </div>
                    ...
                    <div class="formulario__grupo" id="grupo__password2">
                        ...
                        <div class="formulario__grupo-input">
                            <input type="email" class="formulario__input" placeholder="Ingrese su correo " name="correoUsuario" id="correoUsuario">
                        </div>
                    ...
                    <div class="formulario__grupo" id="grupo__password2">
                        ...
                        <div class="formulario__grupo-input">
                            <input type="password" placeholder="Ingrese su contrasena" class="formulario__input" name="contrasenaUsuario" id="contrasenaUsuario">
                        </div>
                    ...
                    <div class="formulario__grupo" id="grupo__password2">
                        ...
                        <div class="formulario__grupo-input">
                            <input type="password" placeholder="Ingrese su contrasena nuevamente" class="formulario__input" name="" id="contrasenaUsuario2">
                        </div>
