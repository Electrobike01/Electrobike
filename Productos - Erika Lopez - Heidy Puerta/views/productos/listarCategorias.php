...
if (isset($_POST)) {
    $categoriaBicicleta = $_POST['enviar'];
    $nombreCat = '';

    if ($categoriaBicicleta == 'bicicletasAltaGama') {
        $nombreCat = 'Bicicletas alta gama';
    }
    if ($categoriaBicicleta == 'bicicletasBajaGama') {
        $nombreCat = 'Bicicletas baja gama';
    }
    if ($categoriaBicicleta == 'repuestosAltaGama') {
        $nombreCat = 'Repuestos alta gama';
    }
    if ($categoriaBicicleta == 'repuestosBajaGama') {
        $nombreCat = 'Repuestos baja gama';
    }
    ...
    $query = $con->query("SELECT * FROM `productos` WHERE categoriaProducto = '$nombreCat'");
    $query->execute();
