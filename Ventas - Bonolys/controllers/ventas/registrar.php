...
$registrarVenta = $con->prepare(" INSERT INTO `ventas`(`idVenta`, `idCliente`, `valorT`, `fechaVenta`) 
VALUES ('', :idc, :vlt, NOW())");
...
//  INSERTAMOS LOS VALORES EN DETALLE COMPRA ------------
    $registrarDetalle = $con->prepare("INSERT INTO `detalleventa`(`idDetalleVenta`, `idProducto`, `idVenta`, `cantidad`, `valor`) 
