        ...
        <form>
            ...
            <main>
                ...
                <div class="formulario__grupo" id="grupo__password2">
                    ...
                    <div class="formulario__grupo-input">
                        <input type="text" class="formulario__input" value="" name="nombreUsuario" id="nombreUsuario_">
                    </div>
                ...
                <div class="formulario">
                    ...
                    <!-- ------ Tipo de documento ------ -->
                        ...
                        <div class="formulario__grupo" id="grupo__usuario">
                            ...
                            <div class="formulario__grupo-input">
                                <select class="formulario__input" name="tipoDocumentoUsuario" id="tipoDocumentoUsuario_">
                    ...
                    <div class="formulario__grupo" id="grupo__password2">
                        ...
                        <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" value="" name="documentoUsuario" id="documentoUsuario_">
                        </div>
                    ...
                    <div class="formulario__grupo" id="grupo__password2">
                        ...
                        <div class="formulario__grupo-input">
                            <input type="text" class="formulario__input" value="" name="contrasenaUsuario" id="contrasenaUsuario_">
                        </div>
                    </div>
                    ...
                    <div class="formulario__grupo" id="grupo__password2">
                        ...
                        <div class="formulario__grupo-input">
                            <input type="password" class="formulario__input" name="" value="" id="contrasenaUsuario2_">
                        </div>
