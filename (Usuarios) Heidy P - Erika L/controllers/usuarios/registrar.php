...
if ($_POST) {
    ...
    $registrarUsuarios = $con->prepare("INSERT INTO `usuarios`(`idUsuario`, `nombreUsuario`, `tipoDocumentoUsuario`, `documentoUsuario`, `correoUsuario`, `contraseñaUsuario`, `estadoUsuario`, `idRol`) 
